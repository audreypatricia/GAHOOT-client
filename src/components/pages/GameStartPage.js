...
class GameStartPage extends Component {
  ...
  componentDidMount(){
    const showGameState = () => {
      ...
      if(this.state.startGame === false){
        ...
        axios.get(`https://gahoot-server.herokuapp.com/games/${this.props.match.params.game_id}.json`).then((results) => {
  ...
  startGame() {
    ...
    axios.put(`https://gahoot-server.herokuapp.com/games/${this.state.game.id}.json`, { gameStart: true }).then((response) => {
